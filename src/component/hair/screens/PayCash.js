...
const PayCash = (props) => {
    ...
    return (
        <View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 17, paddingHorizontal: 30 }}>
                <Text style={styles.textPayDetail}>Tiền khách đưa</Text>
                <Text style={[styles.textPayDetail, { backgroundColor: 'pink' }]}>10,000,000 VNĐ</Text>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 17, paddingHorizontal: 30 }}>
                <Text style={styles.textPayDetail}>Phải thối lại</Text>
                <Text style={[styles.textPayDetail, { backgroundColor: 'pink' }]}>0 VNĐ</Text>
            </View>
            <View>
